 ...
 * This file demonstrates how to integrate Sageiris with a web frontend
 */

// For React/Vue/Angular applications
export class SageirisClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SageirisClient(provider, contractAddress);
